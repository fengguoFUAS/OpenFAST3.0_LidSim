...
!..................................................................................................................................
   ...
   CALL AllocAry( AddOuts%Vlos, p%GatesPerBeam, 'Line-of-sight velocities, m/s', ErrStat2, ErrMsg2 )
         !CALL CheckError( ErrStat2, ErrMsg2 ) not working in OpenFAST 3.0
...
SUBROUTINE SrvD_UpdateStates( t, n, Inputs, InputTimes, p, x, xd, z, OtherState, m, AddOuts,ErrStat, ErrMsg )
!..................................................................................................................................
   ...
   TYPE(SrvD_AddOutsType),         INTENT(IN   )  :: AddOuts     !< Additional outputs for the avrSWAP array for lidar-assisted control
   INTEGER(IntKi),                  INTENT(  OUT) :: ErrStat         !< Error status of the operation
   CHARACTER(*),                    INTENT(  OUT) :: ErrMsg          !< Error message if ErrStat /= ErrID_None
   ...
   IF (p%UseBladedInterface) THEN
      CALL DLL_controller_call(t_next, u_interp, p, x, xd, z, OtherState, m, AddOuts,ErrStat2, ErrMsg2 )
         if (Failed()) return;
   END IF
...
SUBROUTINE DLL_controller_call(t, u, p, x, xd, z,OtherState, m, AddOuts,ErrStat, ErrMsg )
!..................................................................................................................................
   ...
   !IF ( p%UseBladedInterface ) THEN
      ...
      ELSE
         ...
         CALL BladedInterface_CalcOutput( t, u, p, m, xd, AddOuts,ErrStat2, ErrMsg2 )
            CALL SetErrStat( ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName )
...
SUBROUTINE SrvD_CalcOutput( t, u, p, x, xd, z, OtherState, y, m, AddOuts,ErrStat, ErrMsg )
!..................................................................................................................................
   ...
   IF ( p%UseBladedInterface ) THEN
      ...
      IF (.NOT. m%dll_data%initialized) THEN
         CALL DLL_controller_call(t, u, p, x, xd, z,OtherState, m, AddOuts,ErrStat2, ErrMsg2 )
            CALL SetErrStat( ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName )
      END IF
