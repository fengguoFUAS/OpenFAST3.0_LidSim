...
---------------------- FEATURE SWITCHES AND FLAGS ------------------------------ 
      ...
      1   CompLidar       - CompLidar   - Compute Lidar Module (switch) {0 = Off, 1 = On}		
---------------------- INPUT FILES --------------------------------------------- 
...
"Pulsed_2G_LidarFile.dat"	 						SWELidarFile	- Name of file containing SWE Lidar input parameters (quoted string)
---------------------- OUTPUT -------------------------------------------------- 
